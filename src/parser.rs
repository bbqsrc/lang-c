                                                ...
                                                match __choice_res {
                                                    ...
                                                    Failed => {
                                                        let __seq_res = {
                                                            ...
                                                            match __seq_res {
                                                                Matched(__pos, _) => {
                                                                    let __seq_res = __parse_msvc_declspec_specifier(__input, __state, __pos, env);
                                                                    match __seq_res {
                                                                        Matched(__pos, e) => Matched(__pos, { e }),
                                                                        Failed => Failed,
                                                                    }
        ...
        match __choice_res {
            ...
            Failed => {
                let __choice_res = {
                    ...
                    match __seq_res {
                        Matched(__pos, _) => Matched(__pos, { FunctionSpecifier::ForceInline }),
                        Failed => Failed,
                    }
                };
                match __choice_res {
...
fn __parse_msvc_declspec_specifier<'input>(__input: &'input str, __state: &mut ParseState<'input>, __pos: usize, env: &mut Env) -> RuleResult<Vec<Node<Extension>>> {
    #![allow(non_snake_case, unused)]
    {
        let __seq_res = {
            __state.suppress_fail += 1;
            let res = {
                let __seq_res = slice_eq(__input, __state, __pos, "__declspec");
                match __seq_res {
                    Matched(__pos, e) => {
                        let __seq_res = {
                            __state.suppress_fail += 1;
                                            ...
                                            let __seq_res = {
                                                ...
                                                loop {
                                                    ...
                                                    let __step_res = {
                                                        ...
                                                        match __seq_res {
                                                            Matched(__pos, l) => {
                                                                let __seq_res = __parse_msvc_attribute(__input, __state, __pos, env);
                                                                match __seq_res {
                                                                    Matched(__pos, e) => {
                                                                        let __seq_res = Matched(__pos, __pos);
                                                                        match __seq_res {
...
fn __parse_msvc_attribute<'input>(__input: &'input str, __state: &mut ParseState<'input>, __pos: usize, env: &mut Env) -> RuleResult<Extension> {
    #![allow(non_snake_case, unused)]
    {
        let __seq_res = {
            let __seq_res = Matched(__pos, __pos);
